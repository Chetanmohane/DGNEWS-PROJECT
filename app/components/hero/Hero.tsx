...
export default function Hero() {
  return (
    <section id="hero" className="pt-24 pb-12 bg-white dark:bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center justify-between border-b-2 border-gray-100 dark:border-slate-800 pb-4">
            <h3 className="text-2xl font-black tracking-tighter text-gray-900 dark:text-white italic underline decoration-red-600">TRENDING</h3>
          ...
          <div className="space-y-6">
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-slate-100 leading-snug group-hover:text-red-600 transition-colors line-clamp-2">
                    {i === 1 ? "Bhopal Metro ki testing shuru, janiye kab se chalegi" : "Gold rates mein aayi badi giravat, kharidne ka sahi samay"}
                  </h4>
                  <div className="flex items-center gap-3 mt-2">
                    <span className="text-[10px] text-gray-400 dark:text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest italic">Politics</span>
